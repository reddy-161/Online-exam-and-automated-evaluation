        ...
        <div className="glass-panel animate-fade-in" style={{ padding: '2rem', maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div style={{ background: 'rgba(255,255,255,0.05)', padding: '1rem', borderRadius: '12px', border: '1px solid var(--border-subtle)' }}>
                    ...
                    <p style={{ margin: '0.25rem 0 0 0', fontSize: '1.1rem', fontWeight: '500' }}>{user?.name}</p>
                </div>
                ...
                <div style={{ background: 'rgba(255,255,255,0.05)', padding: '1rem', borderRadius: '12px', border: '1px solid var(--border-subtle)' }}>
                    <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Academic Detail</p>
                    <p style={{ margin: '0.25rem 0 0 0', fontSize: '1.1rem', fontWeight: 'bold' }}>
                        {user?.department || 'CSE'} - {user?.section || 'Not Assigned'}
                    </p>
                </div>
            </div>
